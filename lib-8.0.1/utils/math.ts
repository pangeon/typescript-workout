...
export function tryParseNumberString(x: string): 
...
export function tryParseOperatorSymbol(x: string, operators: readonly Operator[]):
  | { isOperatorSymbol: true; operator: Operator } | { isOperatorSymbol: false } 
{
